      ...
      >
        ...
        >
          ...
          <div className="About_second__g9Cy4">
            ...
            >
             MamaEarth is an E-commerce website.
              We were 6 members assigned to complete this project.
               We executed frontend, backend of this project in 6 days.
                My role in this project was building back-end as well as front-end part along with navigation bar.
              <br />
              <br />
        ...
        >
          ...
          <div className="About_second__g9Cy4">
            ...
            <p
              ...
              style={{color: "rgb(137, 147, 177)"}}
            >
             Sephora.com is leading E-Commerce website for all type of 
             cosmetic products such as makeup, skin care, hair,
              fragrance's and tools and brushes.

              I was handelling the front-end part, created and mounted 
              landing page, indian team info page and single player info page.
              <br />
              <br />
              Tech-Stacks we used to build the clone are
              <span style={{color: "rgb(0, 160, 160)"}}>
        ...
        >
          ...
          <div className="About_second__g9Cy4">
            ...
            <p
              ...
              style={{color: "rgb(137, 147, 177)"}}
            >
            ESPNcricinfo - where you can find all the latest cricket news and updates
            . Ball-by-ball commentary, scorecard and stats, Fixtures & Coverage. Match Predictor.
             Statistics. Services: Scores, News & Updates, Teams.

              I was handelling the back-end as well as front-end part, created and mounted 7 category pages, 1 sub-category page and single-product details page.
              <br />
              <br />
              Tech-Stacks we used to build the clone are
              <span style={{color: "rgb(0, 160, 160)"}}>
